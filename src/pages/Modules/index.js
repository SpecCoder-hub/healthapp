    ...
    <>
      ...
      <Main>
        <ModuleCont>
          <ModuleToggle>
            {props.MainState ? (
              <SwitchNav onClick={handleMS}>
                <ToggleIcon
                  src={props.MainState ? bodyIcon1 : bodyIcon}
                ></ToggleIcon>
              </SwitchNav>
            ) : (
              <SwitchNav_Active onClick={handleMS}>
                <ToggleIcon
                  src={props.MainState ? bodyIcon1 : bodyIcon}
                ></ToggleIcon>
              </SwitchNav_Active>
            ...
            {props.PulmunaryState ? (
              <SwitchNav onClick={handlePS}>
                <ToggleIcon
                  src={props.PulmunaryState ? lungsIcon1 : lungsIcon}
                ></ToggleIcon>
              </SwitchNav>
            ) : (
              <SwitchNav_Active onClick={handlePS}>
                <ToggleIcon
                  src={props.PulmunaryState ? lungsIcon1 : lungsIcon}
                ></ToggleIcon>
              </SwitchNav_Active>
            ...
            {props.CardioState ? (
              <SwitchNav onClick={handleCS}>
                <ToggleIcon
                  src={props.CardioState ? heartIcon1 : heartIcon}
                ></ToggleIcon>
              </SwitchNav>
            ) : (
              <SwitchNav_Active onClick={handleCS}>
                <ToggleIcon
                  src={props.CardioState ? heartIcon1 : heartIcon}
                ></ToggleIcon>
              </SwitchNav_Active>
