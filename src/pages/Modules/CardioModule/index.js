        ...
        <StatCont>
          ...
          <ECGCont>
            <VitalMonitor>
              ...
              <MonitorExt>
                <CgArrowsExpandRight onClick={props} />
              </MonitorExt>
            </VitalMonitor>
            <GroupButtons>
        ...
        <ReportsCont>
          <MonitorCont>
            ...
            <>
              <MonitorChart>
                <ChartHead>
                  <HeadSpan>75</HeadSpan> BPM
                </ChartHead>
                <BPMChart data={data} />
              </MonitorChart>
              <MonitorChart>
                <ChartHead>
                  <HeadSpan style={{ color: "#9a575a" }}>110/75</HeadSpan> ASP
                </ChartHead>
                <ASPChart data={data} />
              </MonitorChart>
              <MonitorChart>
                <ChartHead>
                  <HeadSpan>75</HeadSpan> CVP
                </ChartHead>
                <CVPChart data={ecgData} width={400} height={40} />
              </MonitorChart>
              <MonitorChart>
                <ChartHead>
                  <HeadSpan>104</HeadSpan> P02
                </ChartHead>
                <P02Chart data={data} />
              </MonitorChart>
              <MonitorChart>
                <ChartHead>
                  <HeadSpan>630</HeadSpan> Breathing Vol
                </ChartHead>
                <BVolChart data={data} />
              </MonitorChart>
            </>
